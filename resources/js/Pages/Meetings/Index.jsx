                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-indigo-700">
                                            Video and audio meetings will
                                            automatically include a Google Meet
                                            link
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-green-700">
                                            Video and audio meetings will
                                            automatically include Google Meet
                                            links
                                        </p>
                                    </div>
                                </div>
            ...
            >
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <AIDescriptionField
                        ...
                        label="Description"
                        placeholder="Enter meeting description or click 'AI Suggest' for auto-generated content..."
                    ...
                    <AIDescriptionField
                        title={data.title}
                        value={data.agenda}
                        onChange={(value) => setData("agenda", value)}
                        type="meeting"
                        context={{ duration: data.duration }}
                        label="Agenda"
                        placeholder="Meeting topics and discussion points... Press Tab to accept inline suggestions"
                        error={errors.agenda}
                        rows={3}
                    />
                    ...
                    {(data.type === "video" || data.type === "audio") && (
                        <div>
                            ...
                            <input
                                ...
                                placeholder={
                                    googleConnected
                                        ? "Leave empty to auto-generate Google Meet link"
                            ...
                            {googleConnected && !data.meeting_link && (
                                <p className="mt-1 text-xs text-green-600">
                                    ✓ A Google Meet link will be automatically
                                    generated
                                </p>
                            )}
