...
export default function Index({ auth, meetings, users, googleConnected, googleConfigured }) {
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-indigo-900">
                                            Connect Google Calendar for automatic Google Meet links
                                        </p>
                                        <p className="text-xs text-indigo-700">
                                            Video and audio meetings will automatically include a Google Meet link
                                        </p>
                                    </div>
                                </div>
                                <a
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-green-700">
                                            Video and audio meetings will automatically include Google Meet links
                                        </p>
                                    </div>
                                </div>
                                <button
                    ...
                    {(data.type === "video" || data.type === "audio") && (
                        <div>
                            ...
                            <input
                                ...
                                placeholder={googleConnected ? "Leave empty to auto-generate Google Meet link" : "https://meet.google.com/..."}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            />
                            {googleConnected && !data.meeting_link && (
                            ...
                            {!googleConnected && googleConfigured && (
                                <p className="mt-1 text-xs text-gray-500">
                                    <a href={route('google.redirect')} className="text-indigo-600 hover:text-indigo-800">
                                        Connect Google Calendar
                                    </a>
                                    {' '}to auto-generate meeting links
                                </p>
                            )}
                        </div>
                    )}
